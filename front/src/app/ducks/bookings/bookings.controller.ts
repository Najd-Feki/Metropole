...
export class BookingsController {
    ...
    public getBookings(): Observable<any> {
        return this.http.get<any>(environment.api_url + '/reservations');
    }
    ...
    public getBookingById(bookingId: number): Observable<any> {
        return this.http.get<any>(environment.api_url + '/reservations/search/' + bookingId);
    }
    public getEmployeeByName(name ) : Observable<any> {       
        return this.http.get<any>(environment.api_url+'/employees/search/name/'+name);
    }
    ...
    public createBooking(booking: any) {
        return this.http.post(environment.api_url + '/reservations/add', booking);
    }
    ...
    public updateBooking(bookingId: number, booking): Observable<any> {
        return this.http.put<any>(environment.api_url + '/reservations/edit/save', booking);
    }
}
